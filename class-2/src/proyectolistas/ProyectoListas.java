...
"Digite la opción a elegir ";
    ...
    do {
        ...
        switch(opcion){
            case 1:ls.mostrar();
            break;            
            case 2: dato=Integer.parseInt(JOptionPane.showInputDialog("Inserte un dato"));
            ls.insertarFinal(dato);
            break;
            case 3: dato=Integer.parseInt(JOptionPane.showInputDialog("Inserte un dato"));
            ls.insertarInicio(dato);
            break;
            case 4: ls.EliminarPrimerDato();
            break;
            case 5: ls.EliminarUltimo();
            break;
